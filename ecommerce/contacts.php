                                ...
                                <ul id="cats">
          	                   ...
          	                   <div id="content_area" >
                                    ...
                                    <div id="product_box">
                                      ...
                                      <br>
                                      <h2 align="center"> <p style=" color:green; float:center;">For contact: </p></h2>
                                     
                                      <p style="color:orange; font-size:18px; margin-left:25px; margin-right:25px;"> Customer can contact  us or can send feedback  by using our facebook page or below given email address. Their feedbacks are read immediately and response their feedback without any request. </p>

                                     <p style="text-decoration:none; margin-left:277px;"> <a href="facebook/facebook_appliances ">click here to go Facebookpage</a></p>
                                      <p style=" margin-left:277px;"> Email:saroj.mishra773@gmail.com</p>
<br>
<br>
<br>
<br>
