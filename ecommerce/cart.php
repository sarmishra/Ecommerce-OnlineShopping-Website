                                      ...
                                      <?php cart(); ?>
                                       ...
                                       <div id="shopping_cart">
                                        ...
                                        <span style="float:right; font-size:16px; padding:5px; line-hight:40px;">
                                          ...
                                          <b style="color:yellow"> Shooping Cart -</b> Total Item: <?php total_items(); ?>  Total Price:  <?php total_price(); ?> <a href="index.php" style="color:yellow">Back to Shop</a>
                                  ...
                                  <form action="" method="post" enctype="multipart/form-data">
                                     ...
                                     <table align="center" width="700" bgcolor="skyblue">
                                      ...
                                      <tr align="center">
                                        ...
                                        <td><button><a href="checkout.php" style=" text-decoration:none; color:black;">Verification</a></button></td>
